...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_header_header_component__WEBPACK_IMPORTED_MODULE_1__["HeaderComponent"], _main_main_component__WEBPACK_IMPORTED_MODULE_2__["MainComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_3__["HeaderComponent"], _main_main_component__WEBPACK_IMPORTED_MODULE_4__["MainComponent"], _main_home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 16,
      vars: 0,
      consts: [[1, "nav"], ["href", "#home"], ["href", "#about"], ["href", "#portfolio"], ["href", "#contact"]],
  ...
  function srcAppMainHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        ...
        key: "animateWords",
        value: function animateWords() {
          var _this = this;

          var now = 0;
          var last = this.words.length - 1;
          this.putWord(now, last);
          setInterval(function () {
            last = now++;

            if (now >= _this.words.length) {
              now = 0;
            }

            _this.putWord(now, last);
          }, this.speed);
        }
      }, {
        key: "putWord",
        value: function putWord(now, last) {
          var _this2 = this;

          var time1 = this.speed * 0.3;
          var time2 = this.speed * 0.5;
          var count = 0;
          var interval1 = setInterval(function () {
            _this2.elemAnimate.textContent += _this2.words[now][count];
            count++;

            if (count >= _this2.words[now].length) {
              clearInterval(interval1);
            }
          }, time1 / this.words[now].length);
          setTimeout(function () {
            var interval2 = setInterval(function () {
              _this2.elemAnimate.textContent = _this2.elemAnimate.textContent.slice(0, -1);
              count--;

              if (count < 0) {
                clearInterval(interval2);
              }
            }, time1 / _this2.words[now].length);
          }, time2);
        }
      }]);
